      ...
      <div className="absolute top-3 left-4 right-4 z-20 flex items-center justify-between pointer-events-none">
        <div className="pointer-events-auto flex items-center gap-2">
          ...
          {onOpenSatelliteAnalysis && (
            <button
              type="button"
              id="surveillance-upload-satellite-btn"
              onClick={onOpenSatelliteAnalysis}
              className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-[rgba(0,240,255,0.2)] to-[rgba(176,38,255,0.25)] hover:from-[rgba(0,240,255,0.35)] hover:to-[rgba(176,38,255,0.4)] border border-[rgba(0,240,255,0.5)] text-[#E9D5FF] hover:text-white text-xs font-mono font-bold tracking-wider flex items-center gap-1.5 shadow-[0_0_12px_rgba(0,240,255,0.25)] transition-all cursor-pointer"
            >
              <Satellite className="w-3.5 h-3.5 text-[#00F0FF]" />
              <span className="hidden sm:inline">SAR IMAGE ANALYSIS</span>
